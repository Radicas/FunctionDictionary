...
struct ProcessStateRecord
{
     ...
     */
    ProcessStateRecord()
        : retryCount(0), createTime(QDateTime::currentDateTime()), updateTime(QDateTime::currentDateTime())
    {
    }
};
...
struct AIAnalysisRequest
{
     ...
     * @brief 默认构造函数
     */
    AIAnalysisRequest() : priority(0), createTime(QDateTime::currentDateTime()), retryCount(0) {}
};
...
struct AIAnalysisResponse
{
     ...
     * @brief 默认构造函数
     */
    AIAnalysisResponse() : success(false), retryCount(0), responseTime(0), analyzeTime(QDateTime::currentDateTime()) {}
};
...
struct ProcessError
{
     ...
     * @brief 默认构造函数
     */
    ProcessError() : type(ProcessErrorType::None), retryCount(0), recoverable(true) {}
};
